...
// Program options come exclusively from the live course catalog.
// No hardcoded fallback: invented program names must never render, and the
// server (C-panel priority) ordering is preserved — never re-sorted here.
