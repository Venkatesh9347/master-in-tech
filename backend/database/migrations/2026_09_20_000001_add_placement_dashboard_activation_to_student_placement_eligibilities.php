...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('student_placement_eligibilities', function (Blueprint $table) {
            ...
            $table->foreignId('dashboard_status_updated_by')->nullable()->after('dashboard_status_reason')->constrained('users')->nullOnDelete();
    ...
    {
        Schema::table('student_placement_eligibilities', function (Blueprint $table) {
            $table->dropForeign(['dashboard_status_updated_by']);
